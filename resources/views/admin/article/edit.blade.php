...
@section('content')
{{ Session::set('header', 'Edit '.$article->subject) }}
<div class="row">
	<div class="col-md-12">
		<form action="{{ route('article.update', $article) }}" method="POST" role="form" class="form-horizontal">
			{{ csrf_field() }}
			{{ method_field('PATCH') }}
			...
			<div class="form-group{{ $errors->has('subject') ? ' has-error' : '' }}">
				...
				<div class="col-md-8">
					<input type="text" name="subject" id="subject" value="{{ old('subject') ?? $article->subject }}" class="form-control" required autofocus>
			...
			<div class="form-group{{ $errors->has('tags') ? ' has-error' : '' }}">
				...
				<div class="col-md-8">
					<input type="text" name="tags" id="tags" value="{{ old('tags') ?? $article->tags }}" class="form-control">
